...
public abstract class ContainerExecutor implements Configurable {
  ...
  /** DrG YARN-4166
   * Update the container resource, the function has an empty default implementation
   * Override it when the subclass needs to do something
   *
   * @param containerId ID of the Container to be updated
   * @param containerResource New resource of the container
   */
