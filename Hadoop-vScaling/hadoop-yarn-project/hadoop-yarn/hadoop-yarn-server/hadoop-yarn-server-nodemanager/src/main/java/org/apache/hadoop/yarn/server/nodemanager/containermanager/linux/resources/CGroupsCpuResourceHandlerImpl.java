...
public class CGroupsCpuResourceHandlerImpl implements CpuResourceHandler {
  ...
  public List<PrivilegedOperation> updateContainerResource(ContainerId containerId,
      ...
      throws ResourceHandlerException {
    LOG.info("Update the container " + containerId.toString() + "to the target resource " + containerResource.toString());
  ...
  private void setupLimits(String cgroupId,
    ...
    try {
      ...
      LOG.info("target CPU is " + containerResource + "; cpu share is " + cpuShares);
      cGroupsHandler
      ...
      if (strictResourceUsageMode) {
        if (nodeVCores != containerVCores) {
          ...
          //DrG
          LOG.info("Strict Resource Usage Mode, period is " + String.valueOf(limits[0]) + "; quota is " + String.valueOf(limits[1]));
