...
//  }
   ...
   */
  @Override
  public AllocateResponse increaseContainersSize(List<ContainerResourceChangeRequest> increaseRequests,
                                     List<ContainerResourceChangeRequest> decreaseRequests) throws IOException, YarnException {
    return client.allocate(increaseRequests, decreaseRequests);
  }
