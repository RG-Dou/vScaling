...
//  protected final CallbackHandler handler; DRG
  protected final AbstractCallbackHandler handler; //DrG
...
//  }
   ...
   * @param increaseRequests list of request which want to increase the size
   *                         of containers
   * @param decreaseRequests list of request which want to decrease the size
   *                         of containers
   */
  public abstract AllocateResponse increaseContainersSize(List<ContainerResourceChangeRequest> increaseRequests,
   ...
   * </p>
   */
  public interface AbstractCallbackHandler {
...
//    public abstract void onContainersCompleted(List<ContainerStatus> statuses);
     ...
     */
    void onContainersResourceChanged(
