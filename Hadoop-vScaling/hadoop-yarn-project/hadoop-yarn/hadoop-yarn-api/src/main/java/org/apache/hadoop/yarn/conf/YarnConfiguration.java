...
public class YarnConfiguration extends Configuration {
  ...
  /** Max Queue length of <code>OPPORTUNISTIC</code> containers on the NM. DrG */
  ...
  /** Setting that controls whether distributed scheduling is enabled or not. DrG */
  ...
  /** Number of threads container manager uses. DrG*/
  ...
  /** Address where the collector service IPC is. DrG*/
  ...
  /** The number of threads to handle log aggregation in node manager. DrG*/
  ...
  /** Default permissions for container logs. DrG*/
  ...
  /** Minimum container restart interval. DrG*/
  ...
  /** Enable/disable CORS filter. DrG*/
  ...
  /** The delay time ms to unregister container metrics after completion. DrG*/
  @Private
  ...
  /** Prefix for runtime configuration constants.DrG */
  ...
  /** Capabilities allowed (and added by default) for docker containers. DrG**/
   ...
   * perspective, it is best to keep these uppercase. DrG
   */
  ...
  /** Allow privileged containers. Use with extreme care. DrG*/
  ...
  // Configurations for applicaiton life time monitor feature DrG
  ...
  */
   ...
   *  Setting the interval to zero disables the full compaction cycles. DrG
   */
