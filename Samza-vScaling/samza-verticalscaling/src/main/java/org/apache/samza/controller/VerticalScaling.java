...
public class VerticalScaling extends StreamSwitch {
    ...
    public void initResourcesMain2(){
        shrinks.clear();
        expands.clear();
        int mem1 = 1200, mem2 = 1250, mem3 = 1300, mem4 = 1400;
    ...
    public void initResourcesMain4(){
        shrinks.clear();
        expands.clear();
        Resource resource = Resource.newInstance(3000, 5);
        expands.put("000002", resource);
        Resource resource1 = Resource.newInstance(3000, 7);
        expands.put("000003", resource1);
        Resource resource2 = Resource.newInstance(3000, 9);
        expands.put("000004", resource2);
        Resource resource3 = Resource.newInstance(3000, 11);
        expands.put("000005", resource3);
