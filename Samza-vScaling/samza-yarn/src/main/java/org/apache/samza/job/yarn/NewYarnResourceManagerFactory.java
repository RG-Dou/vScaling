 ...
 */
public class NewYarnResourceManagerFactory implements ResourceManagerFactory {

    private static Logger log = LoggerFactory.getLogger(NewYarnResourceManagerFactory.class);
    ...
    public ClusterResourceManager getClusterResourceManager(ClusterResourceManager.Callback callback, SamzaApplicationState state) {
        ...
        NewYarnClusterResourceManager manager = new NewYarnClusterResourceManager(config, jobModelManager, callback, state);
        return manager;
    }
}
