...
public class NewYarnClusterResourceManager extends ClusterResourceManager implements AMRMClientAsync.AbstractCallbackHandler, NMClientAsync.CallbackHandler {
    ...
    public void requestResources(SamzaResourceRequest resourceRequest) {
        ...
        log.info("Allocated Resource for containers: " + allocatedContainers);
    ...
    private void changeContainerSize(String containerId, SamzaResourceRequest resourceRequest, SamzaResource oldResource){
        ...
        log.info("Target: cpu " + requestCores + ", memory " + requestMemMb + ". Original: cpu " + oldCores + ", memory " + oldMemMb);
    ...
    private void changeContainersRM(String containerIdStr, int mem, int cpu, boolean increased){
        ...
        try {
            if(increased) {
                log.info("Start increase resources for " + containerIdStr + ", mem: " + mem + ", cpu: " + cpu);
...
//              }
                ...
                log.info("Start decrease resources for " + containerIdStr + ", mem: " + mem + ", cpu: " + cpu);
            ...
            SamzaResource resource = new SamzaResource(cpu, mem, oldResource.getHost(), oldResource.getResourceID());
            allocatedContainers.put(containerIdStr, resource);
