 ...
 * </p>
 */
public class ExtendedSamzaObjectMapper {
    ...
    public static ObjectMapper getObjectMapper() {
        ...
        SimpleModule module = new SimpleModule("ExtendedSamzaModule", new Version(1, 0, 0, ""));
        ...
        mapper.getSerializationConfig().addMixInAnnotations(ExtendedJobModel.class, JsonExtendedJobModelMixIn.class);
        mapper.getDeserializationConfig().addMixInAnnotations(ExtendedJobModel.class, JsonExtendedJobModelMixIn.class);
