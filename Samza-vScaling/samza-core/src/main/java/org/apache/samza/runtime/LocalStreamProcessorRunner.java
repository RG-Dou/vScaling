...
import org.apache.samza.processor.NewStreamProcessor;
...
public class LocalStreamProcessorRunner {
    ...
    private void run(ApplicationDescriptorImpl<? extends ApplicationDescriptor> appDesc, String containerId,
        ...
        try {
            ...
            NewStreamProcessor processor = createStreamProcessor(jobConfig, appDesc,
    ...
    static NewStreamProcessor createStreamProcessor(Config config, ApplicationDescriptorImpl<? extends ApplicationDescriptor> appDesc,
                                          NewStreamProcessor.StreamProcessorLifecycleListenerFactory listenerFactory) {
        ...
        return new NewStreamProcessor(config, reporters, taskFactory, appDesc.getApplicationContainerContextFactory(),
    ...
    private final class LocalStreamProcessorLifecycleListener implements ProcessorLifecycleListener {
        private final NewStreamProcessor processor;
        LocalStreamProcessorLifecycleListener(NewStreamProcessor processor, Config jobConfig) {
