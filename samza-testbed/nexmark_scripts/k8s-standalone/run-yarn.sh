...
function configAppSrc() {
    ...
    sed -i "s/^\(verticalscaling.cpu.algorithm\)=\(default\|memorySaving\|overhead\)/\1=$Policy/" ${APP_DIR}/testbed_1.0.0/src/main/config/nexmark-q${APP}-memorySaving.properties
