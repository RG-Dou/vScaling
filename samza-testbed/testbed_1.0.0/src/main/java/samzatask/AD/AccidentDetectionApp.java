...
public class AccidentDetectionApp implements TaskApplication {
    ...
    private static final String INPUT_STREAM_ID = "position-reports";
    private static final String OUTPUT_STREAM_ID = "stop-detection";
    ...
    public void describe(TaskApplicationDescriptor taskApplicationDescriptor) {
        ...
        taskApplicationDescriptor.withTaskFactory((StreamTaskFactory) () -> new AccidentDetectionTask(taskApplicationDescriptor.getConfig()));
    }
    ...
    public static void main(String[] args) {
        ...
        LocalApplicationRunner runner = new LocalApplicationRunner(new AccidentDetectionApp(), config);
        runner.run();
